...
/**
 * @ORM\Entity
 * @ORM\Table(name="Notification",indexes={@ORM\Index(name="not_emetteur_idx", columns={"emetteur"}),@ORM\Index(name="not_recepteur_idx", columns={"recepteur"})})
 * @ORM\Entity(repositoryClass="Aeag\AeagBundle\Repository\NotificationRepository")
...
class Notification {
     ...
     * @ORM\SequenceGenerator(sequenceName="notification_seq", initialValue=1, allocationSize=1)
     * ORM\GeneratedValue
     */
    protected $id;
