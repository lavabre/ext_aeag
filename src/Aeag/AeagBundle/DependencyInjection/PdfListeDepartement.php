...
class PdfListeDepartement extends PageGroup {
    ...
    function Header($region) {
        ...
        $this->Cell(100);
        // Titre
        $this->Cell(1, 12, 'Liste des départements de la région ' . $region->getLibelle(), 0, 1, 'C');
        $this->Cell(100);
...
// Tableau coloré
    function Formatage($region, $entities) {
        ...
        foreach ($entities as $entity) {
            $this->Cell($w[0], 4, $entity->getDept(), 'LR', 0, 'C', $fill);
