...
(function($)
{
	...
	$.modal = function(options)
	{
		...
		else
		{
			...
			// Bloc style
			contentWrapper = '<div class="modal-content'+scrollClass+'"'+contentStyle+'>'+content+'</div>';
		}
		...
		{
			$('<ul class="action-tabs right"><li><a href="#" title="Close window"><img src="../../bundles/aeagetatdeslieux/images/icons/fugue/cross-circle.png"" width="16" height="16"></a></li></ul>')
				.prependTo(win)
