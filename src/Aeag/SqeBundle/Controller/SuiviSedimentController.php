...
class SuiviSedimentController extends Controller {
...
//         return new Response ('');   
    ...
    public function lotPeriodesAction($lotanId) {
        ...
        if (count($tabPeriodeAns) == 1) {
            return $this->redirect($this->generateUrl('AeagSqeBundle_suiviSediment_lot_periode_stations', array('periodeAnId' => $tabPeriodeAns[0]['pgProgLotPeriodeAn']->getId())));
        }

        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodes.html.twig', array(
                    'user' => $pgProgWebUser,
                    'lotan' => $pgProgLotAn,
...
//        return new Response ('');   
    ...
    public function lotPeriodeStationsImporterAction($periodeAnId = null, Request $request) {
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationsImporter.html.twig', array(
...
//                        fputs($rapport, $contenu);
    ...
    public function lotPeriodeStationsIntegrerAction($periodeAnId = null, Request $request) {
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationsIntegrer.html.twig', array(
                    'periodeAnId' => $periodeAnId
        ));
...
//        return new Response('');
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationDemande.html.twig', array(
                    'user' => $pgProgWebUser,
                    'lotan' => $pgProgLotAn,
    ...
    public function lotPeriodeStationDemandeSuiviNewAction($prelevId = null, $periodeAnId = null, Request $request) {
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationDemandeSuiviNew.html.twig', array(
                    'prelev' => $pgCmdPrelev,
                    'periodeAnId' => $periodeAnId,
                    'periodeAn' => $pgProgLotPeriodeAn,
                    'dateFin' => $dateFin,
...
//        return new Response ('');
    ...
    public function lotPeriodeStationDemandeSuiviMajAction($suiviPrelId = null, $periodeAnId = null, Request $request) {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('AeagSqeBundle_suiviSediment_lot_periode_stations', array('stationId' => $pgCmdPrelev->getStation()->getOuvFoncId(),
                                'periodeAnId' => $periodeAnId)));
        }

        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationDemandeSuiviMaj.html.twig', array(
                    'prelev' => $pgCmdPrelev,
                    'periodeAnId' => $periodeAnId,
                    'periodeAn' => $pgProgLotPeriodeAn,
                    'dateFin' => $dateFin,
...
//        return new Response ('');
    ...
    public function lotPeriodeStationDemandeSuiviVoirAction($suiviPrelId = null, $periodeAnId = null) {
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationDemandeSuiviVoir.html.twig', array(
                    'prelev' => $pgCmdPrelev,
                    'periodeAnId' => $periodeAnId,
                    'suiviPrel' => $pgCmdSuiviPrel,
                    'chemin' => $pathBase,
...
//        return new Response ('');
    ...
    public function lotPeriodeStationDemandeSuiviDeposerAction($suiviPrelId = null, $periodeAnId = null, Request $request) {
        ...
        return $this->render('AeagSqeBundle:SuiviSediment:lotPeriodeStationDemandeSuiviDeposer.html.twig', array(
                    'prelev' => $pgCmdPrelev,
                    'periodeAnId' => $periodeAnId,
                    'suiviPrel' => $pgCmdSuiviPrel
        ));
