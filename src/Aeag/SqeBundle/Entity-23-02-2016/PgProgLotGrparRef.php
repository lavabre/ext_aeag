 ...
 * PgProgLotGrparRef
 *
 * @ORM\Table(name="pg_prog_lot_grpar_ref",
 *                        indexes={@ORM\Index(name="IDX_PgProgLotGrparRef_grpparref", columns={"grpar_ref_id"}), 
 *                                      @ORM\Index(name="IDX_PgProgLotGrparRef_lot", columns={"lot_id"})})
 * @ORM\Entity
