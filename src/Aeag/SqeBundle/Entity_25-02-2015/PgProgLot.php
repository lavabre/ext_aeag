 ...
 * PgProgLot
 *
 * @ORM\Table(name="pg_prog_lot", indexes={@ORM\Index(name="IDX_69CCDB0C1EE6AB3A", columns={"zgeo_ref_id"}), @ORM\Index(name="IDX_69CCDB0C9E494911", columns={"marche_id"}), @ORM\Index(name="IDX_69CCDB0CE01F52FC", columns={"code_milieu"}), @ORM\Index(name="IDX_69CCDB0CA10273AA", columns={"titulaire_id"})})
 * @ORM\Entity
