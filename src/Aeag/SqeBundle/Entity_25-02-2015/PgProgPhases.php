...
class PgProgPhases
{
     ...
     * @var string
     *
     * @ORM\Column(name="type_phase", type="string", length=3, nullable=false)
     */
    private $typePhase;
     ...
     * Set typePhase
     *
     * @param string $typePhase
     * @return PgProgPhases
     */
    public function setTypePhase($typePhase)
    {
