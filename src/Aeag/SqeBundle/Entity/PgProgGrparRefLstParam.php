 ...
 *
 * @ORM\Table(name="pg_prog_grpar_ref_lst_param", 
 *                       indexes={@ORM\Index(name="IDX_PgProgGrparRefLstParam_grparRef", columns={"grpar_ref_id"}), 
 *                                     @ORM\Index(name="IDX_PgProgGrparRefLstParam_codeParametre", columns={"code_parametre"}), 
 *                                     @ORM\Index(name="IDX_PgProgGrparRefLstParam_uniteDefaut", columns={"unite_defaut"}), 
 *                                     @ORM\Index(name="IDX_PgProgGrparRefLstParam_codeFraction", columns={"code_fraction"})})
 * @ORM\Entity
