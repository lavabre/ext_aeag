 ...
 *
 * @ORM\Table(name="pg_prog_presta_webusers", uniqueConstraints={@ORM\UniqueConstraint(name="uk_cmd_presta_login", columns={"login"})},
 *                       indexes={@ORM\Index(name="IDX_PgProgPrestaWebusers_presta", columns={"presta_id"})})
 * @ORM\Entity
