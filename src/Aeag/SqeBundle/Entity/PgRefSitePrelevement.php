 ...
 *
 * @ORM\Table(name="pg_ref_site_prelevement", uniqueConstraints={@ORM\UniqueConstraint(name="uk_pg_ref_site_prelevement", columns={"ouv_fonc_id", "code_site"})}, 
 *                       indexes={@ORM\Index(name="IDX_PgRefSitePrelevement_codeSupport", columns={"code_support"}), 
 *                                     @ORM\Index(name="IDX_PgRefSitePrelevement_ouvFonc", columns={"ouv_fonc_id"})})
 * @ORM\Entity
