 ...
 * PgProgGrpParamRef
 *
 * @ORM\Table(name="pg_prog_grp_param_ref", 
 *                       indexes={@ORM\Index(name="IDX_PgProgGrpParamRef_support", columns={"support"}), 
 *                                     @ORM\Index(name="IDX_PgProgGrpParamRef_codeMilieu", columns={"code_milieu"})})
 * @ORM\Entity
