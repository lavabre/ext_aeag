...
class ControleVraisemblance {
    ...
    public function controleVraisemblanceNew($mesure, $codeRq, $codeParametre, $inSitu, $codePrelevement, $demandeId, $reponseId) {
        ...
        // III.1
        $this->_champsNonRenseignes($mesure, $codeRq, $codeParametre, $inSitu);

        // III.1.1
        $this->_champsNonRenseignesEtValeursVides($mesure, $codeRq, $codeParametre, $inSitu);

        // III.2
        $this->_valeursNumeriques($mesure, $codeRq);
        ...
        $this->_modeleWeiss($mTxSatOx, $mOxDiss, $mTEau, $mConductivite);
        ...
        $this->_balanceIonique($cCationParams, $cAnionParams);
        
        // III.9 Comparaison Balance ionique / conductivité (Feret)
        $this->_balanceIoniqueTds2($cCationParams, $cAnionParams, $mConductivite);
        ...
        $this->_pourcentageHorsOxygene($tabMesures);
        ...
        $this->_sommeParametresDistincts($sommeParams, $resultParams, $params);
    }
