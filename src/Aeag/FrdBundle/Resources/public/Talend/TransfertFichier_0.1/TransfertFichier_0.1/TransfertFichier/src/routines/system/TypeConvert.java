...
public class TypeConvert {
     ...
     * 
     */
    public static String Date2String(Date o, String path) {
        if (o == null)
            return null;
        return TalendDate.formatDate(path, o);
    }
    ...
    public static Date String2Date(String o, String path) {
        if (o == null || "".equals(o.trim()))
            return null;
        return TalendDate.parseDate(path, o);
    }
