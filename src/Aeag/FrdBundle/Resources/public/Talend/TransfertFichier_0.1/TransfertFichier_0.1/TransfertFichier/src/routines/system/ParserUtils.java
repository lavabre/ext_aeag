...
public class ParserUtils {
    ...
    public synchronized static java.util.Date parseTo_Date(String s, String path) {
        ...
        // try {
        // date = FastDateParser.getInstance(path).parse(s);
        // } catch (java.text.ParseException e) {
        // e.printStackTrace();
        // System.err.println("Current string to parse '" + s + "'");
        // }
        DateFormat format = FastDateParser.getInstance(path);
    ...
    public synchronized static java.util.Date parseTo_Date(String s, String path, boolean lenient) {
        // check the parameter for supporting " ","2007-09-13"," 2007-09-13 "
        if (s != null) {
            s = s.trim();
        }
        ...
        // System.err.println("Current string to parse '" + s + "'");
        // }
        DateFormat format = FastDateParser.getInstance(path, lenient);
        ParsePosition pp = new ParsePosition(0);
        pp.setIndex(0);
        date = format.parse(s, pp);
        if (pp.getIndex() != s.length() || date == null) {
    ...
    public static java.util.Date parseTo_Date(java.util.Date date, String path) {
        // java.text.SimpleDateFormat simpleDateFormat = new java.text.SimpleDateFormat(path);
        // java.util.Date date = null;
        // try {
